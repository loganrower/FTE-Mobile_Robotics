...
import copy
from scripts.OccGrid import BaseOccupancyGrid, BinaryOccupancyGrid
...
class PlannerBase(ABC):
        ...
        **unused,
        ...
        if occgrid is not None:
            ...
            if inflate > 0:
                ...
                self._occgrid = self._occgrid.copy()   # Make a copy, so that the original occgrid is not changed
    ...
    def goal(self, goal):
        ...
        """
        if goal is not None:
            if self.isoccupied((goal[0], goal[1])):
